...
('The New York Times', 'NYT', 'nyt', 'https://res.cloudinary.com/demo/image/upload/nyt_logo.png', 'https://www.nytimes.com', TRUE, 92.50, TRUE, TRUE),
('Wall Street Journal', 'WSJ', 'wsj', 'https://res.cloudinary.com/demo/image/upload/wsj_logo.png', 'https://www.wsj.com', TRUE, 91.00, FALSE, TRUE),
('BBC World', 'BBC', 'bbc-world', 'https://res.cloudinary.com/demo/image/upload/bbc_logo.png', 'https://www.bbc.com', TRUE, 94.00, TRUE, FALSE),
('Reuters', 'Reuters', 'reuters', 'https://res.cloudinary.com/demo/image/upload/reuters_logo.png', 'https://www.reuters.com', TRUE, 95.50, TRUE, FALSE),
('Al Jazeera', 'AJ', 'al-jazeera', 'https://res.cloudinary.com/demo/image/upload/aj_logo.png', 'https://www.aljazeera.com', TRUE, 85.00, TRUE, FALSE),
('Financial Times', 'FT', 'financial-times', 'https://res.cloudinary.com/demo/image/upload/ft_logo.png', 'https://www.ft.com', TRUE, 93.00, TRUE, TRUE),
('Associated Press', 'AP', 'associated-press', 'https://res.cloudinary.com/demo/image/upload/ap_logo.png', 'https://apnews.com', TRUE, 96.00, FALSE, FALSE),
('Bloomberg', 'Bloomberg', 'bloomberg', 'https://res.cloudinary.com/demo/image/upload/bloomberg_logo.png', 'https://www.bloomberg.com', TRUE, 90.00, FALSE, FALSE);

-- ============================================================
-- Reporters
-- ============================================================
INSERT INTO reporters (name, slug, title, bio, truth_score, is_verified, is_independent, source_id) VALUES
('Elena Richardson', 'elena-richardson', 'Conflict Zone Specialist', 'Award-winning journalist covering global conflicts and humanitarian crises with over 15 years of field experience.', 91.00, TRUE, TRUE, NULL),
('Marcus Thorne', 'marcus-thorne', 'Deep Tech Analyst', 'Former Silicon Valley engineer turned technology journalist. Specializes in AI, quantum computing, and emerging tech.', 88.50, TRUE, TRUE, NULL),
('Sarah Chen', 'sarah-chen', 'Asia-Pacific Correspondent', 'Based in Singapore, covering economic and political developments across the Asia-Pacific region.', 89.00, TRUE, FALSE, 4),
('James Okafor', 'james-okafor', 'Africa Bureau Chief', 'Veteran journalist reporting on African politics, economics, and social issues for over two decades.', 87.50, TRUE, TRUE, NULL),
('Maria Santos', 'maria-santos', 'Latin America Editor', 'Pulitzer Prize nominee covering Latin American affairs, trade, and democratic movements.', 93.00, TRUE, FALSE, 7),
('David Park', 'david-park', 'Climate & Energy Reporter', 'Environmental journalist and author. Covers climate policy, renewable energy, and sustainability.', 90.00, TRUE, TRUE, NULL);
...
(1, 'The New York Times - Daily Edition', 'https://res.cloudinary.com/demo/image/upload/nyt_front.jpg', NULL, CURRENT_DATE),
(2, 'Wall Street Journal - Daily Edition', 'https://res.cloudinary.com/demo/image/upload/wsj_front.jpg', NULL, CURRENT_DATE),
(6, 'Financial Times - Daily Edition', 'https://res.cloudinary.com/demo/image/upload/ft_front.jpg', NULL, CURRENT_DATE);
...
(3, 'BBC World', 'BBC World Service live radio broadcast covering global news 24/7.', 'https://stream.bbc.co.uk/bbc_world_service', 'https://res.cloudinary.com/demo/image/upload/bbc_radio.jpg', TRUE, TRUE, 45200, 1),
(4, 'Market Update', 'Reuters live market analysis and financial news commentary.', 'https://stream.reuters.com/live_market', 'https://res.cloudinary.com/demo/image/upload/reuters_radio.jpg', TRUE, TRUE, 23100, 2),
(4, 'Reuters Financial Brief', 'Daily financial briefing with in-depth market analysis.', 'https://stream.reuters.com/financial_brief', 'https://res.cloudinary.com/demo/image/upload/reuters_financial.jpg', TRUE, FALSE, 18700, 3),
(5, 'Al Jazeera', 'Al Jazeera live English radio service covering Middle East and world news.', 'https://stream.aljazeera.com/live_english', 'https://res.cloudinary.com/demo/image/upload/aj_radio.jpg', TRUE, TRUE, 31500, 4),
(6, 'Financial Times', 'FT live business and financial news radio broadcast.', 'https://stream.ft.com/live_radio', 'https://res.cloudinary.com/demo/image/upload/ft_radio.jpg', TRUE, TRUE, 19800, 5),
(1, 'The NYT', 'New York Times audio news and analysis.', 'https://stream.nytimes.com/live_audio', 'https://res.cloudinary.com/demo/image/upload/nyt_radio.jpg', TRUE, FALSE, 27300, 6);
...
('Climate Accord 2.0', 'climate-accord-2', 89000, '+19% engagement', NULL, TRUE),
('Semiconductor Rivalry', 'semiconductor-rivalry', 76000, '+8% engagement', 3, TRUE),
('AI Regulation Framework', 'ai-regulation-framework', 92000, '+24% engagement', NULL, TRUE),
('Digital Currency Revolution', 'digital-currency-revolution', 65000, '+12% engagement', 1, TRUE);
...
(1, 'Electric Aviation', '+124% interest in Western Europe', 9, NULL, CURRENT_DATE),
(2, 'Remote Work Policy', '+108% interest in North America', 7, 18, CURRENT_DATE),
(3, 'Nuclear Fusion', '+96% interest in East Asia', 11, NULL, CURRENT_DATE),
(1, 'Digital Currency Adoption', '+156% interest in South America', 8, 12, CURRENT_DATE),
(2, 'Green Energy Infrastructure', '+89% interest in South Asia', 12, 14, CURRENT_DATE),
(3, 'AI Healthcare Systems', '+78% interest in Southeast Asia', 13, NULL, CURRENT_DATE);

-- ============================================================
-- World Map Insights
-- ============================================================
INSERT INTO world_map_insights (title, description, latitude, longitude, icon_type, article_id, is_active) VALUES
('East Europe: Strategic realignment detected near border', 'Military movements and diplomatic shifts observed in Eastern European border regions.', 50.4501, 30.5234, 'alert', 11, TRUE),
('Central Asia: New trade agreement signed', 'Central Asian nations finalize comprehensive economic cooperation framework.', 41.2995, 69.2401, 'trade', NULL, TRUE),
('South Pacific: Climate summit concludes', 'Pacific Island nations reach consensus on climate action and adaptation funding.', -17.7134, 178.0650, 'climate', 9, TRUE),
('North Africa: Infrastructure development', 'Major infrastructure projects announced across North African nations.', 33.9716, -6.8498, 'development', NULL, TRUE);

-- ============================================================
-- Compare Coverages
-- ============================================================
INSERT INTO compare_coverages (topic_title, is_active) VALUES
('G7 Climate Agreements', TRUE),
('AI Regulation Approaches', TRUE);
